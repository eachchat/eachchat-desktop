...
function pollForUpdates() {
    ...
    try {
        ...
        if (!latestUpdateDownloaded) {
            ...
            (_a = global.mainWindow) === null || _a === void 0 ? void 0 : _a.webContents.send('update-downloaded', latestUpdateDownloaded);
        }
    }
    catch (e) {
...
function start(updateBaseUrl) {
    ...
    try {
        ...
        if (process.platform === 'darwin') {
            ...
            url = `${updateBaseUrl}macos/?localVersion=${encodeURIComponent(electron_1.app.getVersion())}`;
        }
...
electron_1.ipcMain.on('check_updates', pollForUpdates);
function ipcChannelSendUpdateStatus(status) {
    var _a;
    (_a = global.mainWindow) === null || _a === void 0 ? void 0 : _a.webContents.send('check_updates', status);
}
...
electron_1.autoUpdater.on('update-downloaded', (ev, releaseNotes, releaseName, releaseDate, updateURL) => {
    var _a;
    // forward to renderer
