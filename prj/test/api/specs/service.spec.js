import {services} from "../../../src/packages/data/services.js"
...
describe('ServiceTest', function () {
  ...
  it("gmsConfigurationTestCase", async function(){
    let ret = await services.gmsConfiguration("dev.eachchat.net");
  ...
  it("LoginTestCase", async function(){
    ...
    await services.init();
    let loginResult = await services.login(config);
    expect(loginResult).to.equal(true);
    this.selfUser = await services.GetSelfUserModel();
  })

  it("UpdateMessagesTestCase", async function(){
    return;
    let response = await services.UpdateMessages();
  ...
  it("AllUserinfoTestCase", async function (){
    return;
    this.timeout(300000);
    let result = await services.AllUserinfo();
    console.log(result)
  ...
  it("AllDepartmentInfoTestCase", async function(){
    return;
    this.timeout(30000);
    let result = await services.AllDepartmentInfo();
    expect(result).to.equal(true);
  })
  ...
  it("listAllGroupTestCase", async function(){
    return;
    this.timeout(500000);
    let result = await services.listAllGroup();
    expect(result).to.equal(true);
  })

  it("ListMessageCollectionTestCase", async function(){
    return;
    let netRes = await services.ListMessageCollections();
  ...
  it("ListPictrueCollectionTestCase", async function(){
    return;
    let netRes = await services.ListPictureCollections();
  ...
  it("ListFileCollectionsTestCase", async function(){
    return;
    let netRes = await services.ListFileCollections();
  ...
  it("ListGroupCollectionsTestCase", async function(){
    return;
    let netRes = await services.ListGroupCollections();
  ...
  it("ListTopicCollectionsTestCase", async function(){
    return;
    let netRes = await services.ListTopicCollections();
  ...
  it("updateUserWorkDescriptionTestCase", async function(){
    ...
    let result = await services.updateUserWorkDescription(workDescription);
  ...
  it("updateUserStatusDescriptionTestCase", async function(){
    ...
    let result = await services.updateUserStatusDescription(statusDescription);
    expect(result.ok).to.equal(true);
  ...
  it("CreateGroupTestCase", async function(){
    ...
    this.resCreateGroup = await services.CreateGroup("test group", ["eb69c200e11801906322203ad59ff885", "8a93c2debb75bc4204f03c88c9dc11b1", "381c86d8e2aca3e992224d5b3061c442", "e3b18ba88b23296d6bb28fb23baab034", "516fec24899afddbe0b9f51378da6372",
  ...
  it("AddGroupUserTestCase", async function(){
    //let res = await services.AddGroupUsers('5f06c25bcc10105b06aff96b', ["157668e1fc2c0a054af0244116a09e36"]);
    let res = await services.AddGroupUsers(this.resCreateGroup.group_id, ["157668e1fc2c0a054af0244116a09e36"]);
  ...
  it("DeleteGroupUserTestCase", async function(){
    //let res = await services.DeleteGroupUsers("5f06c25bcc10105b06aff96b",["157668e1fc2c0a054af0244116a09e36"]);
    let res = await services.DeleteGroupUsers(this.resCreateGroup.group_id,["157668e1fc2c0a054af0244116a09e36"]);
    expect(res).to.equal(true);
  })

  it("DeleteGrupTestCase", async function(){
    let res = await services.DeleteGroup(this.resCreateGroup.group_id);
    expect(res).to.equal(true);
  })
  ...
  it("sendNewMessageTestCase", async function(){
    ...
    let response = await services.sendNewMessage(msgID, 101, "25d4cb78d54840dfa70df0dfa847c024", "5e815b92cc101019c46c2eea", "eb69c200e11801906322203ad59ff885", curTimeSeconds, {text:"test message"});
  ...
  it("UploadFileTestCase", async function(){
    ...
    let result = await services.uploadFile(filepath);
    console.log(result);
  })
  ...
  it("CollectMessageTestCase", async function(){
    ...
    let result = await services.CollectMessage(array);
    expect(result).to.equal(true);
  })

  it("CollectGroupTestCase", async function(){
    return;
      let result = await services.CollectGroup("5e9ea897cc10101597c8959f", this.selfUser.id);
      expect(result).to.equal(true);
  })
  //collectoinfile
  //collectionphoto
  ...
  it("SearchUserTestCase", async function(){
    return;
    this.timeout(30000);
    let result = await services.SearchUser("测试员");
  ...
  it("SearchFilesTestCase", async function(){
    return;
    this.timeout(30000);
    let result = await services.SearchFiles("pdf", 0, 10, undefined, ["5eb8067ecc101030003a41a4", "5eba49dccc10107d8ba6c3aa", "5ee7607bcc1010262607a20f", "5e06f4ad0a50417215194beb","5e1156960a50411e50d0cf4b"], 0)
    //console.log(result)
    expect(result).to.not.equal(false);
  ...
  it("UpdateUserAvatarTestCase", async function(){
    //let tmp = await services.UpdateUserAvatar("C:\\Users\\chengfang\\Desktop\\laofuzi.png");
    //console.log(tmp);
    ...
    await services.UpdateUserAvatarByData(filedata, filename, filemime);
    return
  })
  
  it("GetRecentDeviceTestCase", async function(){
//response = await services.GetRecentDevice();
...
// = await services.UpdateUserAvatar("C:\\Users\\chengfang\\Desktop\\laofuzi.png");
//response = await services.UpdateGroupAvatar("5ec4fda7cc101002783bcb77", "C:\\Users\\chengfang\\Desktop\\laofuzi.png");

//response = await services.SearchAll("测试");
...
//response = await services.SearchCollection(101, "1")
//response = await services.GetRecentDevice();
//response = await services.GetNewVersion();

//for(let index in response){
//console.log(response[index].sequenceValue)
//}
//await services.ListGroupFiles("5eec82a1cc10105e30d318a5", "0");
//response = await services.historyMessage("5e815b92cc101019c46c2eea", "449677749993881600", 20);
//for(let index in response){
//    console.log(response[index].sequence_id)
//}
//response = await services.ListAllMessage("5eec82a1cc10105e30d318a5","471405801505308672")
//await services.SearchGroupFiles("5eec82a1cc10105e30d318a5", "0", "检测");
//response = await services.ListAllMessage("5eec82a1cc10105e30d318a5", "471464492426346496");
//response = await services.SearchGroupMessage("5e815b92cc101019c46c2eea", "1", 20)
//console.log(response)

//response = await services.SearchMessage("1", 20)
